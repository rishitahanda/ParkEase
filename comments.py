...
from streamlit_option_menu import option_menu  # Used to create styled horizontal/vertical option menus

# --------- Data Manipulation ---------
import pandas as pd  # Used for handling tabular data, not actively used in this code but imported

# --------- Custom Modules (Your Own Python Scripts) ---------
import login  # Handles authentication and mailing functions
import space1w  # Contains functions related to Parking Lot 1
import space2w  # Contains functions related to Parking Lot 2
import space3w  # Contains functions related to Parking Lot 3

# --------- Base64 (Built-in Python Module) ---------
import base64  # Used to encode image and video files in base64 for embedding into HTML/CSS
